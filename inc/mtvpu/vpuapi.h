...
#define WAVE6_ENC_AV1_DEFAULT_CDF_BUF_SIZE          (48*1024)
...
/**
@verbatim
This command sets the VA-API information to operate with VA-API interface. (WAVE6 only)
Host should call this command before call VPU_EncIssueSeqInit/VPU_EncStartOneFrame function.
Please refer the <<vpuapi_h_VaapiInfo>>.
@endverbatim
*/
    ENC_SET_VAAPI_INFO,
/**
 ...
 */
 typedef enum {
    ...
    FORMAT_PVRIC_RGB_32BIT_UUUU_8X8,      /**< RGB 8-bit U8U8U8U8(32bit) Tile type 8x8 PVRIC format */
    FORMAT_PVRIC_RGB_32BIT_UUUU_16X4,     /**< RGB 8-bit U8U8U8U8(32bit) Tile type 16x4 PVRIC format */
    FORMAT_PVRIC_RGB_32BIT_UUUU_32X2,     /**< RGB 8-bit U8U8U8U8(32bit) Tile type 32x2 PVRIC format */
    FORMAT_PVRIC_RGB_P10_32BIT_ARBG_8X8,  /**< RGB 10-bit A2R10B10G10(32bit) Tile type 8x8 PVRIC format */
    FORMAT_PVRIC_RGB_P10_32BIT_ARBG_16X4, /**< RGB 10-bit A2R10B10G10(32bit) Tile type 16x4 PVRIC format */
    FORMAT_PVRIC_RGB_P10_32BIT_ARBG_32X2, /**< RGB 10-bit A2R10B10G10(32bit) Tile type 32x2 PVRIC format */
 ...
 */
typedef enum {
    PRODUCT_ID_NONE=0, /* for multi cards */
    PRODUCT_ID_980,
    PRODUCT_ID_960,
    PRODUCT_ID_521,
    PRODUCT_ID_511,
...
#define PRODUCT_ID_W6_SERIES(x)     (x == PRODUCT_ID_627 || x == PRODUCT_ID_637)
#define PRODUCT_ID_W_SERIES(x)      (x == PRODUCT_ID_627 || x == PRODUCT_ID_637 || x == PRODUCT_ID_521 || x == PRODUCT_ID_511 || x == PRODUCT_ID_517)
...
*/
    ...
    PVRIC_COMPRESSED_FRAME_MAP                  = 17, /**< PVRIC compressed frame map type (WAVE6 only) */
    ...
    PVRIC_COMPRESSED_FRAME_LOSSLESS_MAP         = 21, /**< PVRIC compressed frame map type for lossless mode (WAVE5 only) */
    PVRIC_COMPRESSED_FRAME_LOSSY_MAP            = 22, /**< PVRIC compressed frame map type for lossy mode (WAVE5 only) */
    ...
    TILED_YUV_FRAME_MAP                         = 26, /**< Tiled YUV(YUV420 8bit) frame map type. (WAVE6 AV1 Encoder only) */
    TILED_MAP_TYPE_MAX
} TiledMapType;
...
typedef struct {
    ...
    Uint32  fwCompileDate;              /**< The F/W compile date */
} VpuAttr;
...
*/
typedef struct {
    Uint32 hour; /**< It specifies the hour of timestamp. */
    Uint32 min;  /**< It specifies the minute of timestamp. */
    Uint32 sec;  /**< It specifies the second of timestamp. */
    Uint32 ms;   /**< It specifies the millisecond of timestamp. */
} TimestampInfo;
...
*/
    ...
    int              pvricFbcEnable; /**< This field enables VPU to generate PVRIC FBC format(Imagination Power VR Image Compress Frame Buffer Compression) format of decoded frames. */
/**
@verbatim
PVRIC FBC Mode
...
*/
    ...
    Uint32  pvricIfbcTilePadY;   /**< Padding data of Y which are used when ifbc tile is not aligned with tile width/height (default value : 0x0) */
    Uint32  pvricIfbcTilePadUv;  /**< Padding data of UV which are used when ifbc tile is not aligned with tile width/height (default value : 0x200) */
/**
@verbatim
Constant colour detected value for channel 0,1,2,3 (default value: 0x0)

@ [7:0] = colour ch0 or Pixel[7:0]

@ [15:8] = colour ch1 or Pixel[15:8]

@ [23:16] = colour ch2 or Pixel[23:16]

@ [31:24] = colour ch3 or Pixel[31:24]
@endverbatim
*/
    Uint32  pvricCrCh013Val0;
/**
@verbatim
Constant colour detected value for channel 0,1,2,3 (default value:  0x0100_0000)
...
@endverbatim
*/
    Uint32  pvricCrCh013Val1;
/**
@verbatim
Constant colour detected value for y-plane. (default value: 0x0)

@ [9:0] = 10bit Y value

@ [9:2] = 8bit Y value, bits[1:0] ignored
@endverbatim
*/
    Uint32  pvricCrYVal0;
/**
@verbatim
Constant colour detected value for uv-plane. (default value: 0x0)

@ [9:0] = 10bit UV value

@ [9:2] = 8bit UV value, bits[1:0] ignored
@endverbatim
*/
    Uint32  pvricCrUvVal0;
/**
@verbatim
Constant colour detected value for y-plane. (default value: 0x3ff)
...
@endverbatim
*/
    Uint32  pvricCrUvVal1;
    Uint32  pvricLossyThreshArgb10;          /**< Thresholds for ARGB10 bit reduction (default value: 0x23) */
    Uint32  pvricLossyThreshYuv8;            /**< Thresholds for YUV8 bit reduction (default value: 0x6DB48B) */
    Uint32  pvricLossyThreshYuv10p10;        /**< Thresholds for YUV10 PACK10 bit reduction (default value: 0x56B794) */
    Uint32  pvricLossyThreshYuv10p16;        /**< Thresholds for YUV10 PACK16 bit reduction (default value: 0x31F691) */
    Uint32  pvricLossyThreshAlpha;           /**< Constant alpha detection threshold (default value: 0x04) */
    Uint32  pvricLossyThreshColourDiff8bit;  /**< Palette encoding thresholds for ARGB8 (default value: 0x329) */
    Uint32  pvricLossyThreshColourDiff10bit; /**< Palette encoding thresholds for ARGB10 (default value: 0x429) */
    Uint32  pvricLossyPredictorMode;         /**< Lossy compression predictor mode  (default value: 0x0) */
    Uint32          vaSliceNum;        /**< It indicates the number of VA-API slice parameter for one frame. */
    Uint32          vaRenderTarget;    /**< It indicates the target of VA-API rendering buffer. */
    PhysicalAddress vaParamAddr;       /**< It specifies the buffer address of VA-API parameter. */
...
typedef struct {
    ...
    Uint32 qpI;        /**< A QP value of I Pictures. */
    Uint32 qpP;        /**< A QP value of P Pictures. */
    Uint32 qpB;        /**< A QP value of B Pictures. */
} TemporalLayerParam;
...
/**
 * @brief    This is a data structure for setting Pre-processing scaler parameters. (WAVE6 only)
 */
typedef struct {
    BOOL enable;    /**< It indicates an enable flag of scaler. */
    Uint32 width;   /**< It indicates a width of scaler. */
    Uint32 height;  /**< It indicates a height of scaler. */
/**
@verbatim
It indicates a coefficient mode of scaler.
...
*/
    Uint32 coefMode;
    Int32 horPhase; /**< It indicates a horizontal initial phase value of scaler. (-127 ~ 127). */
    Int32 verPhase; /**< It indicates a vertical initial phase value of scaler. (-127 ~ 127). */
} EncScalerInfo;
#endif
#ifdef SUPPORT_ENC_CROP
/**
 * @brief    This is a data structure for setting Pre-processing crop parameters. (WAVE6 only)
 */
typedef struct {
    BOOL enable;  /**< It indicates an enable flag of crop. */
    VpuRect rect; /**< <<vpuapi_h_VpuRect>>. */
} EncCropInfo;
#endif
/**
 * @brief    This is a data structure for VA-API interface. (WAVE6 only)
 */
 typedef struct {
    Uint16 seqParamNum;                     /**< It specifies the number of VA-API sequence parameter for one frame. */
    Uint16 picParamNum;                     /**< It specifies the number of VA-API picture parameter for one frame. */
    Uint16 sliceParamNum;                   /**< It specifies the number of VA-API slice parameter for one frame. */
    Uint16 packedSeqParamNum;               /**< It specifies the number of VA-API packed sequence parameter for one frame. */
    Uint16 packedPicParamNum;               /**< It specifies the number of VA-API packed picture parameter for one frame. */
    Uint16 packedSliceParamNum;             /**< It specifies the number of VA-API packed slice parameter for one frame. */
...
* 0  : It specifies the enable flag of VAEncMiscParameterTypeFrameRate.
* 1  : It specifies the enable flag of VAEncMiscParameterTypeRateControl.
* 32 : It specifies the enable flag of VAEncMiscParameterTypeHRD.
@endverbatim
*/
    Uint16 miscEnable;
    PhysicalAddress seqParamBufAddr;        /**< It specifies the buffer address of VA-API sequence parameter.  */
    PhysicalAddress picParamBufAddr;        /**< It specifies the buffer address of VA-API picture parameter. */
    PhysicalAddress sliceParamBufAddr;      /**< It specifies the buffer address of VA-API slice parameter. */
    PhysicalAddress packedParamBufAddr;     /**< It specifies the buffer address of VA-API packed parameter. */
    PhysicalAddress packedParamDataBufAddr; /**< It specifies the buffer address of VA-API packed parameter data. */
    PhysicalAddress miscFrameRateBufAddr;   /**< It specifies the buffer address of VA-API misc frame rate parameter. */
...
/**
@verbatim
A period of IDR picture (0 ~ 2047). (AVC only)
...
/**
@verbatim
A period of intra picture (0 ~ 2047).
...
/**
@verbatim
It specifies a size of slice. (2^29 - 1). (HEVC/AVC only).
...
*/
    ...
    Uint32 rdoBiasBlk4;                            /**< It specifies amount of penalty for block 4x4. (0 ~ 255). */
    Uint32 rdoBiasBlk8;                            /**< It specifies amount of penalty for block 8x8. (0 ~ 255). */
    Uint32 rdoBiasBlk16;                           /**< It specifies amount of penalty for block 16x16. (0 ~ 255). */
    Uint32 rdoBiasBlk32;                           /**< It specifies amount of penalty for block 32x32. (0 ~ 255). (HEVC/AV1 only). */
    Uint32 rdoBiasIntra;                           /**< It specifies amount of penalty for intra mode. (0 ~ 255) */
    Uint32 rdoBiasInter;                           /**< It specifies amount of penalty for inter mode. (0 ~ 255) */
/**
@verbatim
@* It specifies amount of penalty for skip and direct mode of AVC. (0 ~ 255).
@* It specifies amount of penalty for merge mode of HEVC. (0 ~ 255).
@* It specifies amount of penalty for skip mode of AV1. (0 ~ 255).
@endverbatim
*/
    Uint32 rdoBiasMerge;
    Uint32 enRdoBias;                              /**< It enables custom RDO bias. */
...
*/
    ...
    Uint32 colTileNum;                             /**< It specifies the number of tile rows.  (1 ~ 16). (AV1 only). */
...
/**
@verbatim
It specifies the number of temporal layer. (0 ~ 4).
...
*/
    ...
    BOOL enIntraBC;                                /**< It enables Intra block copy. (AV1 only). */
/**
@verbatim
It enables double the height of MV search range. (AV1 only).

@* 0 : disable
@* 1 : extend height of CME search range and use one CME mv candidate
@* 2 : extend height of CME search range and use two CME mv candidates
@endverbatim
*/
    Uint32 largeSearchRange;
    BOOL en8x8IDTX;                                /**< It enables 8x8 IDTX. It means skip the transform for 8x8. (AV1 only). */
} EncWave6Param;
...
typedef enum {
    ...
    W6_ENC_CHANGE_PARAM_RDO_BIAS           = (1<<21),
...
#endif
#ifdef SUPPORT_ENC_CROP
    EncCropInfo     cropInfo; /**< <<vpuapi_h_EncCropInfo>> */
#endif
...
/**
* @brief    This is a data structure for setting PVRIC block. (WAVE6 encoder only).
*/
typedef struct {
/**
@verbatim
This variable enables the pvric macro block format. Refer to PVRIC V4 Intergration guide.
(This variable is only meaningful when PVRIC_YUV420 FrameBufferFormat and cbcrInterleave is 1)

@* 0 : disable MACRO BLOCK FORMAT
@* 1 : enable MACRO BLOCK FORMAT
@endverbatim
*/
   BOOL   enMBFormat;
   BOOL   lossy;            /**< It enables lossy mode. Refer to PVRIC V4 Intergration guide. */
/**
@verbatim
This variable defines the swizzle encoding mode. Refer to PVRIC V4 Intergration guide.
(This variable is only meaningful when PVRIC_RGB FrameBufferFormat)
...
@* 8 : SWIZZLE_RGBA mode
@* 9 : SWIZZLE_RBGA mode
@* 10 : SWIZZLE_GRBA mode
@* 11 : SWIZZLE_GBRA mode
@* 12 : SWIZZLE_BGRA mode
@* 13 : SWIZZLE_BRGA mode
@endverbatim
*/
   Uint32 swizzleMode;
   Uint32 clearColourHigh;  /**< This variable defines high address of clear colour. Refer to PVRIC Intergration guide. */
   Uint32 clearColourLow;   /**< This variable defines low address of clear colour. Refer to PVRIC Intergration guide. */
   Uint32 reqTagId;         /**< This variable defines requester tag. Refer to PVRIC Intergration guide. */
   Uint32 reqSubTagId;      /**< This variable defines requester sideband tag. Refer to PVRIC Intergration guide. */
   Uint32 iCtrlInvCtx;      /**< This variable defines invalidated context. Refer to PVRIC Intergration guide. */
/**
@verbatim
When set to 1 will cause invalidation of all headers associated with the fbc_fbdc_inval_context
when there is an fbc to fbdc invalidation cycle.
Refer to PVRIC V4 Intergration guide.
@endverbatim
*/
   Uint32 cdcInvOverride;
/**
@verbatim
When set to 1 any compressor tiles that are determined to be corrupted are filtered and
the tile data returned will be that specified by fbc_fbdc_cr_y_val0 if a YUV pixel format else fbc_fbdc_cr_ch0123_val0.
Always tie to 1.
Refer to PVRIC V4 Intergration guide.
@endverbatim
*/
   Uint32 enFilter;
   Uint32 clearFilter;      /**< When set to 1 will clear the fbc_fbdc_cr_filter_status bit to 0. Refer to PVRIC Intergration guide. */
   Uint32 crYVal0;          /**< This variable defines constant colour detected value for y-plane. Refer to PVRIC Intergration guide. */
   Uint32 crUvVal0;         /**< This variable defines constant colour detected value for uv-plane. Refer to PVRIC Intergration guide. */
   Uint32 crYVal1;          /**< This variable defines constant colour detected value for y-plane. Refer to PVRIC Intergration guide. */
   Uint32 crUvVal1;         /**< This variable defines constant colour detected value for uv-plane. Refer to PVRIC Intergration guide. */
   Uint32 ch0123Val0;       /**< This variable defines constant colour detected value for channel 0,1,2,3. Refer to PVRIC Intergration guide. */
   Uint32 crCh0123Val1;     /**< This variable defines constant colour detected value for channel 0,1,2,3. Refer to PVRIC Intergration guide. */
} WavePvricParam;
...
typedef struct {
    union{
        struct {
            Uint32 reserved : 1;
            Uint32 osiBreakException : 1;
            Uint32 osiResetVector : 1;
            Uint32 coprocessor3Exception : 1;
            Uint32 coprocessor2Exception : 1;
            Uint32 coprocessor1Exception : 1;
            Uint32 coprocessor0Exception : 1;
            Uint32 busErrorException : 1;
            Uint32 doubleFaultException : 1;
            Uint32 swResetCarry : 1;
            Uint32 hwResetFlag : 1;
            Uint32 runningInstNum : 5;
            Uint32 swResetCount : 16;
        } flags;
        Uint32 data;
    } fwStatus;
} WaveStatus;
...
typedef enum {
    VPU_EXCEPTION_NONE         = 0,
    VPU_EXCEPTION_DOUBLE_FAULT = 1,
    VPU_EXCEPTION_BUS_ERROR    = 2,
    VPU_EXCEPTION_COPROCESSOR0 = 3,
    VPU_EXCEPTION_COPROCESSOR1 = 4,
    VPU_EXCEPTION_COPROCESSOR2 = 5,
    VPU_EXCEPTION_COPROCESSOR3 = 6,
    VPU_EXCEPTION_OSI_RESET_VECTOR = 7,
    VPU_EXCEPTION_OSI_BREAK    = 8,
    VPU_EXCEPTION_MAX          = 9,
} VPU_EXCEPTION_TYPE;
...
typedef struct {
    ...
    Uint32 lr;
    Uint32 swResetCount;
    VPU_EXCEPTION_TYPE exceptionType;
    uint32_t runningInstNum;
    uint32_t isHwReset;
} VpuDbgStatus;
...
RetCode VPU_InitWithFW(Uint32 coreIdx, const Uint8* code, Uint32 size);
RetCode VPU_InitWithoutFW(Uint32 coreIdx);
...
RetCode VPU_DecRegisterFrameBuffer2(
    DecHandle    handle,            /**< [Input] A decoder handle obtained from VPU_DecOpen() */
    FrameBuffer* bufArray,          /**< [Input] The allocated frame buffer address and information in <<vpuapi_h_FrameBuffer>>. If this parameter is NULL, this function (not HOST application) allocates frame buffers.  */
    int          numOfDecFbs,       /**< [Input] The number of compressed frame buffer  */
    int          numOfDisplayFbs,   /**< [Input] The number of linear frame buffer when WTL is enabled. In WAVE, this should be equal to or larger than framebufDelay of <<vpuapi_h_DecInitialInfo>> + 2. */
...
/**
* @brief    This function is used to set the secondary AXI configuration for wave517.
 */
void VPU_DecSecAxiParamFill(
    int               codecMode,    /**< [Input]  Video COD_STD for WAVE seriers */
    DecInitialInfo *  info,         /**< [Input]  Decoding info */
    SecAxiUse *       secAxiUse     /**< [Output] structure that holds information of secondary AXI configuration */
    );

/**
* @brief    This function is used to set the secondary AXI configuration for wave627.
 */
void VPU_EncSecAxiParamFill(
    EncOpenParam* pEncOpen,     /**< [Input]  Encoding info */
    SecAxiUse *   secAxiUse     /**< [Output] structure that holds information of secondary AXI configuration */
    );
...
/**
* @brief    This function is used to update the physical address when the PA changes
handle: instance handle, Each instance needs to be updated separately
paInfo: Contains the current PA type, the old address and the new address, and the first element must be the workBuffer (if the workBuffer has also changed physical address).
memCnt: Number of memory, first element must be the workBuffer if the workBuffer has also changed physical address
* @return result
*/
...
/**
* @brief    This function is used to wakeup vpu , updatePaMask is use to tell vpu to wait update pa
* @return result
*/
RetCode VPU_WakeWaitUpdatePa(
    Uint32 coreIdx,
    Uint32 updatePaMask
    );

/**
* @brief    This function is used to get vpu's Program Counter(PC) Register and Link Register(LR)
* @return result
*/
RetCode VPU_GetFwStatus(
    Uint32 coreIdx,
    VpuDbgStatus *dbg_status
    );

/**
* @brief    Split a separate free inst interface from the enc/dec CLOSE interface
* @return result
*/
